...
**`inference_demo.py`** (v1): Εκτελεί πρόβλεψη σε δείγματα του DFEW
(φάκελοι με ήδη cropped καρέ).

**`inference_demo_v2.py`** (v2): Επέκταση που δέχεται επιπλέον ακατέργαστα
αρχεία βίντεο. Όταν η είσοδος είναι βίντεο, εντοπίζει και αποκόπτει αυτόματα
το πρόσωπο (OpenCV Haar cascade) πριν την πρόβλεψη. Όταν είναι φάκελος DFEW,
τα καρέ είναι ήδη cropped και η ανίχνευση παρακάμπτεται.

Σημείωση: Σε τυχαία βίντεο τα αποτελέσματα είναι ενδεικτικά. Ο Haar cascade
είναι βασικός μετωπικός ανιχνευτής και το μοντέλο εκπαιδεύτηκε σε
DFEW-aligned crops, οπότε εκτός κατανομής η αξιοπιστία μειώνεται.
